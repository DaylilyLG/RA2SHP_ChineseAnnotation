...
当然，如果对弹头不满意，还可以新增弹头，比如复制弹头 [SAMWH] 的所有语句代码到任意位置（注意不同部分之间要留空行），改成好记的名字 [SAMWH2]，并在弹头注册表中注册 `SAMWH2` ，这样新的弹头就做好啦！是不是很简单！像这样的做法当然还可以用在武器主体还有单位主体上，当然都要注册一下，注册是好习惯！（注意抛射体是无需注册的，只需记住：有对应注册表的都要注册）。  
